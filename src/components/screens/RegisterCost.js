                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{flex: 1}}>
                        ...
                        >
                            <View style={{flex: 1}}>
                                ...
                                />
                                <Button title="انصراف" onPress={this.toggleModal} buttonStyle={{backgroundColor: '#47b03e'}} />
                            </View>
                        </Modaldate>
                    </View>
                    ...
                    <View style={{flexDirection: 'row',flex:1}}>
                        ...
                        <View style={{marginTop: 15, fontSize: 16, flex: 1}}>
                            <Text style={{fontSize: 14, marginRight: 5, fontFamily: 'IRANSansMobile',flex: 2}}>از درآمد</Text>
                        </View>
                    ...
                    <View style={{flexDirection: 'row',flex:1}}>
                        ...
                        <View style={{marginTop: 15, fontSize: 16, flex: 1}}>
                            <Text style={{fontSize: 14, marginRight: 15, fontFamily: 'IRANSansMobile',flex: 2}}>هزینه</Text>
                        </View>
                    ...
                    <View style={{flexDirection: 'row',flex:1}}>
                        ...
                        <View style={{marginTop: 15, fontSize: 16, flex: 1}}>
                            <Text style={{fontSize: 14, marginRight: 5, fontFamily: 'IRANSansMobile',flex: 2}}>روش پرداخت </Text>
                        </View>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <View style={{marginTop: 15, flex: 1}}>
                            <Text style={{fontSize: 14, marginRight:15, fontFamily: 'IRANSansMobile',flex:2}}> حساب</Text>
                ...
                <Modal
                    ...
                    <LinearGradient
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 20, color: '#fff', marginBottom: 5, fontFamily: 'Far_Aref' }}>
                                اضافه کردن روش پرداختی جدید                           </Text>
                        </View>
                    </LinearGradient>
                    <View style={{flexDirection: 'row', marginTop: 20}}>
                        <View style={styles.SectionStyle}>
